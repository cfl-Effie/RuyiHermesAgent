...
const COMPATIBLE_DISPLAY_NAMES = ['RuyiHermesAgent', 'Ruyi Agent', 'Hermes']
...
$processNames = @('RuyiHermesAgent', 'ruyi-agent', 'Hermes')
...
function main() {
  ...
  try {
    ...
    if (stamp.repository !== 'DaPengRuYi/RuyiHermesAgent')
