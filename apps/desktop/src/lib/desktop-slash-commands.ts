...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active RuyiHermesAgent profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show RuyiHermesAgent runtime version', surface: exec() },
