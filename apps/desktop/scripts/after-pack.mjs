 ...
 *
 * Stamps the RuyiHermesAgent icon + identity onto the packed Windows executable via
 ...
 *   - packager.appInfo.productFilename: the exe basename (e.g. 'RuyiHermesAgent')
 */
...
export default async function afterPack(context) {
  ...
  try {
    ...
    throw new Error(`[after-pack] RuyiHermesAgent executable identity stamp failed: ${err.message}`)
  }
}
