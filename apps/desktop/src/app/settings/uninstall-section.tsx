...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The RuyiHermesAgent runtime, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the RuyiHermesAgent runtime, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the RuyiHermesAgent desktop app and runtime (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — RuyiHermesAgent, its runtime, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall RuyiHermesAgent</p>
