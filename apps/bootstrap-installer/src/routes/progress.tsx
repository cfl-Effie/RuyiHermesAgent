...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating RuyiHermesAgent' : 'Setting up RuyiHermesAgent'
  const description = isUpdate
    ? 'RuyiHermesAgent is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The RuyiHermesAgent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
